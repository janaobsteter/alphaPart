### alphaPartition_deterministic_MCMC.R
###-----------------------------------------------------------------------------
### $Id$
###-----------------------------------------------------------------------------
...
## method to show how to use alphaPartition with MCMC results!
##
...
(res <- alphaPartition(x=ped, colPath="loc", colAGV=c("agv1", "agv2")))
...
(res <- alphaPartition(x=ped, colPath="loc.sex", colAGV=c("agv1", "agv2")))
...
###-----------------------------------------------------------------------------
### alphaPartition_deterministic_MCMC.R ends here
