#' savePlot.plotSummaryAlphaPartition.R
#'
#' TODO: Generic savePlot.
#'
#' Function \code{\link[grDevices]{savePlot}} from the \pkg{grDevices} package
...
#' method in the \pkg{grDevices} package; \code{\link[alphaPartition]{savePlot.plotSummaryAlphaPartition}}
#' help page on the method for the objects of \code{plotSummaryAlphaPartition} class; and
#' \code{\link[alphaPartition]{plot.summaryAlphaPartition}} for ploting results of summaryAlphaPartition object.
#'
...
#' @describeIn savePlot Save plot objects on the disk for permanent storage.

savePlot.default <- function # Default savePlot method
  ### Default \code{savePlot} method.
(
...
#' @describeIn savePlot Save plot objects of class \code{plotSummaryalphaPartition} on the disk for
#' permanent storage.
#'
#' @export


savePlot.plotSummaryAlphaPartition <-

function # Save plots on the disk 
  ###
(
  x,                                           ##<< plotSummaryalphaPartition, output object from
  ...
  if(!("plotSummaryAlphaPartition" %in% class(x))) stop("'x' must be of a 'plotSummaryAlphaPartition' class")
  ...
  ##value<< Beside the side effect of saving plots to disk, filenames are printed on
