#' print.alphaPartition.R
#'
#' Print method for the output of alphaPartition function.
#'
...
#' in \code{x}.
#' @seealso
#' \code{\link[alphaPartition]{alphaPartition}}, \code{\link{head}}, \code{\link{tail}}.
#'
#' @param x alphaPartition, output object from \code{\link[alphaPartition]{alphaPartition}} function.
